...
<form action="index.php?page=uploads&action=uploadFile" method="post" enctype="multipart/form-data" align="center">
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSelect file to upload  <input type="file" name="f" ></br><br>
    Name the File: &nbsp <input type="text" name="t" ></br><br>
